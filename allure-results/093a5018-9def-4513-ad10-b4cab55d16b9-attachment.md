...
- Name: test
- Location: C:\Users\DS\Documents\PlaywrightAutomationtest\tests\verifydesktopprice.spec.js:4:5
...
Locator: locator('text=$230')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=$230')

    at C:\Users\DS\Documents\PlaywrightAutomationtest\tests\verifydesktopprice.spec.js:17:28
```
...
```ts
  ...
  13 |   await page.getByRole('link', { name: 'Monitors' }).click();
  14 |
  15 |   
  16 |   const checkprice = await page.locator('text=$230')
> 17 |   await expect(checkprice).toBeVisible()
     |                            ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  18 |
